...
(function(g) {
    ...
    konte.instantSearch = function() {
        var t = null,
            ...
            n = null,
            r = g("#search-modal"),
            c = r.find(".modal-header"),
            l = r.find(".modal-content"),
            d = r.find("form"),
            u = d.find("input.search-field"),
            f = r.find(".search-result"),
            p = f.find(".view-more a"),
            i = r.find(".quick-links"),
            h = r.find("input[name=post_type]").val();
        if (!r.length) {
            return
        }
        ...
        new PerfectScrollbar(f.find(".searched-items").get(0), {
                ...
                t = g.post(a, {
                    ...
                    if ("product" === h) {
                        ...
                        if (o.length) {
                            ...
                            s[i] = {
                                found: false,
                                text: g(".woocommerce-info", t).text()
                            }
                        }
                    } else {
                        ...
                        if (n.length) {
                            ...
                            s[i] = {
                                found: true,
                                items: g('<div class="posts row" />').append(n),
                                url: a
                            }
                        } else {
                            s[i] = {
                                found: false,
                                text: g(".no-results .nothing-found-message", t).text()
                            }
                        }
                    }
                    m(s[i])
        ...
        function m(e) {
            var t = "product" === h ? "woocommerce" : "",
                o = f.find(".searched-items");
            r.removeClass("searching");
    ...
    konte.toggleListDropdown = function() {
        g(document.body).on("click", ".list-dropdown ul li", function() {
            var e = g(this);
            e.closest(".list-dropdown").removeClass("open").find(".current .selected").text(e.text())
        });
    ...
    konte.toggleHamburgerScreen = function() {
        g(document.body).on("click", ".header-hamburger", function(e) {
            ...
            var n = g("#fullscreen-menu", o),
                i = g(".filter-widgets", o),
                a = g(".social-icons", o),
                s = g(".currency", o),
                r = g(".language", o),
                c = 100,
    ...
    konte.featuredContentCarousel = function() {
        var e = g("#featured-content-carousel"),
            t = {
                rtl: !!konte.data.rtl,
    ...
    konte.productQuantityButtons = function() {
        g(document.body).on("click", ".quantity .increase, .quantity .decrease", function(e) {
            ...
            var t = g(this),
                o = t.siblings(".qty"),
                n = parseFloat(o.val()),
                i = parseFloat(o.attr("min")),
                a = parseFloat(o.attr("max")),
                s = parseFloat(o.attr("step"));
            n = n ? n : 0;
            i = i ? i : 0;
            a = a ? a : n + 1;
            s = s ? s : 1;
    ...
    konte.singleProductAjaxAddToCart = function() {
        ...
        g(document.body).on("submit", "form.cart", function() {
            var e = g(this),
                n = e.find(".single_add_to_cart_button"),
                t = e.attr("action") ? e.attr("action") : window.location.href,
                o = e.serialize();
            if (e.closest("div.product").hasClass("product-type-external")) {
                return
            }
            n.removeClass("added").addClass("loading disabled").prop("disabled", true);
            if (n.attr("name")) {
                o += "&" + encodeURI(n.attr("name")) + "=" + encodeURI(n.attr("value"))
            }
            g.ajax({
                url: t,
                data: o + "&konte_add_to_cart_nonce=" + konte.data.add_to_cart_nonce,
                method: e.attr("method") ? e.attr("method").toUpperCase() : "POST",
                success: function(e) {
                    n.removeClass("loading disabled").addClass("added").prop("disabled", false);
                    if (konte.data.cart_open_after_added !== "1") {
                        var t = g(e).find(".woocommerce-error, .woocommerce-info, .woocommerce-message"),
                            o = g(".konte-woocommerce-alert");
                        if (t.length) {
                            if (!o.length) {
                                o = g('<div class="konte-woocommerce-alert"></div>');
                                g(document.body).append(o)
                            }
                            o.html(t);
                            setTimeout(function() {
                                o.addClass("active")
                            }, 500);
                            if (t.hasClass("woocommerce-message")) {
                                setTimeout(function() {
                    ...
                    if (g(e).find(".woocommerce-message").length) {
    ...
    konte.toggleProductTabs = function() {
        ...
        g(document.body).off("click", ".woocommerce-tabs.panels-offscreen .wc-tabs li a, .woocommerce-tabs.panels-offscreen ul.tabs li a").on("click", ".woocommerce-tabs.panels-offscreen .wc-tabs li a", function(e) {
            e.preventDefault();
            var t = g(this),
                o = t.closest(".wc-tabs-wrapper, .woocommerce-tabs"),
                n = o.find(".wc-tabs, ul.tabs"),
                i = o.find(".panels"),
                a = o.find(t.attr("href"));
            ...
            e.preventDefault();
            var t = g(this).closest(".wc-tabs-wrapper, .woocommerce-tabs"),
                o = t.find(".panels"),
                n = o.find(".panel.open");
            n.removeClass("open");
            ...
            if (e.keyCode === 27) {
                var t = g(".wc-tabs-wrapper, .woocommerce-tabs"),
                    o = t.find(".panels"),
                    n = o.find(".panel.open");
                n.removeClass("open");
                t.find(".tabs").children("li").removeClass("active");
    ...
    konte.productBackgroundFromGallery = function(o) {
        ...
        var t = o.find(".woocommerce-product-gallery"),
            e = t.find(".wp-post-image"),
            n = new BackgroundColorTheif;
        e.one("load", function() {
            setTimeout(function() {
                i(e.get(0))
            }, 100)
    ...
    konte.singleProductV1 = function() {
        var e = g("div.product.layout-v1");
        if (!e.length || typeof BackgroundColorTheif == "undefined") {
            return
        }
        g(".woocommerce-product-gallery", e).one("jetpack-lazy-loaded-image load", ".wp-post-image", function() {
            ...
            if (o) {
                setTimeout(function() {
                    ...
                    var t = o.closest(".woocommerce-product-gallery");
                    if (e && t.length) {
                        t.height(e)
                    }
                }, 100)
        ...
        e.css({
            paddingTop: g("#masthead").height()
        });
        if (!e.hasClass("background-set") && konte.data.product_auto_background === "1") {
    ...
    konte.singleProductV3 = function() {
        ...
        function e() {
            var e = g(window).height() - i.outerHeight() - g("#colophon").outerHeight() + 19,
                t = g("#topbar"),
                o = g(".footer-main");
            if (t.length) {
                e -= t.outerHeight()
            ...
            n.find(".woocommerce-product-gallery").css({
                maxHeight: e,
                height: e
            })
        }
    ...
    konte.singleProductV4 = function() {
        ...
        setTimeout(function() {
            var e = n.find(".woocommerce-product-gallery"),
                t = e.find(".flex-control-thumbs"),
        ...
        if ("dropdown" === konte.data.product_quantity_input_style) {
            n.find(".quantity .qty").quantityDropdown()
        }
    };
    konte.singleProductV5 = function() {
        var n = g("div.product.layout-v5"),
            o = n.find(".summary"),
            i = o.children(".summary-inner"),
            a = g(window),
            e = g("#masthead").height(),
            s = false;
        if (!n.length) {
    ...
    konte.loginPanelAuthenticate = function() {
        g("#login-panel").on("submit", "form.login", function e(t) {
            var o = g("input[name=username]", this).val(),
                n = g("input[name=password]", this).val(),
                i = g("input[name=rememberme]", this).is(":checked"),
                a = g("input[name=woocommerce-login-nonce]", this).val(),
                s = g("[type=submit]", this),
                r = g(this),
    ...
    konte.productsMasonry = function() {
        var n = g("ul.products.layout-masonry"),
            i = g(window);
    ...
    konte.productsCarousel = function() {
        ...
        r.on("reachEnd", function() {
            ...
            g(s).addClass("swiper-slide loading-placeholder").css({
                height: r.height - 140
    ...
    konte.productQuickView = function() {
        g(document.body).on("click", ".quick_view_button", function(e) {
            ...
            var t = g(this),
                o = t.data("product_id"),
                n = g("#" + t.data("target")),
                i = n.find(".woocommerce"),
                a = wc_add_to_cart_params ? wc_add_to_cart_params.wc_ajax_url.toString().replace("%%endpoint%%", "product_quick_view") : konte.data.ajax_url;
            n.addClass("loading");
            i.find(".product").html("");
            g.post(a, {
            ...
            function s() {
                var e = i.find(".product"),
                    t = e.find(".woocommerce-product-gallery"),
                    o = e.find(".variations_form");
    ...
    konte.modifyVariationSwatches = function(e) {
        var t = false;
        if (e.find(".tawcvs-swatches").length) {
            t = true
        }
        if (!t) {
            e.removeClass("swatches-support")
        }
        e.off("tawcvs_no_matching_variations");
        e.on("tawcvs_no_matching_variations", function() {
            event.preventDefault();
            e.find(".woocommerce-variation.single_variation").show();
            if (typeof wc_add_to_cart_variation_params !== "undefined") {
                e.find(".single_variation").stop(true, true).slideDown().html('<p class="invalid-variation-combination">' + wc_add_to_cart_variation_params.i18n_no_matching_variations_text + "</p>")
            }
        })
    };
    konte.loadMoreProducts = function() {
        ...
        function o() {
            var t = g(".woocommerce-navigation.ajax-navigation"),
                o = g("a", t);
        ...
        function n(a, s) {
            var r = a.closest(".woocommerce-navigation"),
                c = a.attr("href");
            g.get(c, function(e) {
                var t = g("#main", e),
                    o = g("ul.products", t),
    ...
    konte.productsQuickSearch = function() {
        ...
        l.on("submit", function(e) {
            e.preventDefault();
            var s = g("ul.products.main-products"),
                r = l.find(":input:not(:checkbox):not(:button)"),
                c = l.attr("action"),
                t = c.indexOf("?") !== -1 ? "&" : "?",
                o = r.filter(function() {
                    return g(this).val() != 0
    ...
    konte.productsTools = function() {
        ...
        var i = e.find("#products-filter");
        if (i.length && i.hasClass("dropdown-panel")) {
            o();
            n.on("resize", o)
        }
        ...
        g(document.body).on("konte_products_filter_before_send_request konte_products_filter_reseted", function() {
            if (i.hasClass("offscreen-panel")) {
                konte.closeOffCanvas(i)
            } else {
                i.fadeOut(function() {
                    i.removeClass("open")
                })
        ...
        var e = {
            onChange: function(e) {
                var t = e.$quantity.closest(".woocommerce-mini-cart-item"),
                    ...
                    i = wc_add_to_cart_params.wc_ajax_url.toString().replace("%%endpoint%%", "update_cart_item");
                if (g.fn.block) {
                    t.block({
                        message: null,
                        overlayCSS: {
    ...
    konte.stickyScrollDown = function() {
        var e = g(window),
            t = g(".sticky-scrolldown"),
            o = false,
            n, i = g("#masthead").height();
        if (!t.length) {
            return
        }
        t.on("click", function() {
            g("html, body").animate({
                scrollTop: e.scrollTop() + e.height()
            }, 800)
        });
        a();
    ...
    konte.popup = function() {
        ...
        var i = parseInt(konte.data.popup_frequency),
            e = parseInt(konte.data.popup_visible_delay);
    ...
    konte.preloader = function() {
        var t = g("#preloader");
        if (!konte.data.preloader || !t.length) {
            return
        }
        var o = false;
    ...
    konte.responsiveProductV3 = function() {
        var e = g(window),
            t = g(".woocommerce div.product.layout-v3");
        if (!t.length) {
            return
        }
        o();
    ...
    konte.responsiveProductGallery = function() {
        ...
        var e = g(window),
            t = g(".woocommerce div.product"),
            o = false,
            n = {};
        if (!t.length) {
            return
        }
        var i = g(".woocommerce-product-gallery", t),
            a = i.clone(),
            s = false;
    ...
    konte.portfolioFilter = function() {
        var e = g(".portfolio-filter"),
            a = g(".portfolio-projects"),
            s = a.siblings(".navigation");
        ...
        e.on("click", "a", function(e) {
            ...
            g.get(i, function(e) {
                var t = g(".portfolio-projects", e),
                    o = g(".hentry", t),
                    n = t.siblings(".navigation");
    ...
    konte.lazyLoadImages = function() {
        ...
        g(document.body).on("post-load konte_posts_loaded konte_products_loaded konte_products_quick_search_request_success konte_flex_posts_loaded konte_product_quickview_loaded konte_lazy_load_images", function() {
            try {
                t = new Event("jetpack-lazy-images-load", {
                    bubbles: true,
                    cancelable: true
                })
            } catch (e) {
