...
(function(factory) {
    ...
    $.extend(Timepicker.prototype, {
        ...
        _newInst: function($input, opts) {
            ...
            overrides = {
                ...
                onClose: function(dateText, dp_inst) {
                    if (tp_inst.timeDefined === !0 && $input.val() !== '') {
            ...
            if (tp_inst._defaults.altField) {
                ...
                if (tp_inst._defaults.altRedirectFocus === !0) {
        ...
        _limitMinMaxDateTime: function(dp_inst, adjustSliders) {
            ...
            if (adjustSliders !== undefined && adjustSliders === !0) {
        ...
        _onTimeChange: function() {
            ...
            var hour = (this.hour_slider) ? this.control.value(this, this.hour_slider, 'hour') : !1,
                minute = (this.minute_slider) ? this.control.value(this, this.minute_slider, 'minute') : !1,
                second = (this.second_slider) ? this.control.value(this, this.second_slider, 'second') : !1,
                millisec = (this.millisec_slider) ? this.control.value(this, this.millisec_slider, 'millisec') : !1,
                microsec = (this.microsec_slider) ? this.control.value(this, this.microsec_slider, 'microsec') : !1,
        ...
        _updateDateTime: function(dp_inst) {
            ...
            if (this._defaults.timeOnly === !0 && this._defaults.timeOnlyShowDate === !1) {
                formattedDateTime = this.formattedTime
            } else if ((this._defaults.timeOnly !== !0 && (this._defaults.alwaysSetTime || timeAvailable)) || (this._defaults.timeOnly === !0 && this._defaults.timeOnlyShowDate === !0)) {
                formattedDateTime += this._defaults.separator + this.formattedTime + this._defaults.timeSuffix
            }
            this.formattedDateTime = formattedDateTime;
            if (!this._defaults.showTimepicker) {
                this.$input.val(this.formattedDate)
            } else if (this.$altInput && this._defaults.timeOnly === !1 && this._defaults.altFieldTimeOnly === !0) {
    ...
    $.datepicker.formatTime = function(format, time, options) {
        ...
        tmptime = tmptime.replace(/(?:HH?|hh?|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g, function(match) {
            switch (match) {
                ...
                case 'z':
                    return $.timepicker.timezoneOffsetString(time.timezone === null ? options.timezone : time.timezone, !1);
                case 'Z':
                    return $.timepicker.timezoneOffsetString(time.timezone === null ? options.timezone : time.timezone, !0);
                case 'T':
    ...
    $.datepicker._selectDate = function(id, dateStr) {
        ...
        if (tp_inst && inst.settings.showTimepicker) {
            tp_inst._limitMinMaxDateTime(inst, !0);
    ...
    $.datepicker._updateDatepicker = function(inst) {
        ...
        if (typeof(inst.stay_open) !== 'boolean' || inst.stay_open === !1) {
    ...
    $.datepicker._disableTimepickerDatepicker = function(target) {
        ...
        if (tp_inst) {
            inst.settings.showTimepicker = !1;
            tp_inst._defaults.showTimepicker = !1;
    ...
    $.datepicker._enableTimepickerDatepicker = function(target) {
        ...
        $(target).datepicker('getDate');
        if (tp_inst) {
            inst.settings.showTimepicker = !0;
            tp_inst._defaults.showTimepicker = !0;
            tp_inst._addTimePicker(inst);
            tp_inst._updateDateTime(inst)
        }
    };
